 ...
 *
 *
 * NONE OF THIS SPECIFY THE ORDER OF THE LIST
 */
...
public class TTT3DMover {
  ...
  private List<TTT3DMove> winningMoves(TTT3DBoard board, Character currentPlayer, List<TTT3DMove> moves) {
    ...
    winningMovesRightDiagonalLevel(board, currentPlayer, moves);
      ...
      for (int c = 0; c < 4; c++) {
        for (int r = 0; r < 4; r++) {
          if (board.valueInSquare(l, r, c).equals('-')) {
            TTT3DBoard temp = new TTT3DBoard(board, currentPlayer);
  ...
  public TTT3DMove bestMove(TTT3DBoard board) {
    ...
    public static void main(String[] args) {
      ...
      try {
        ...
        System.out.println();
        TTT3DBoard bo = new TTT3DBoard("/Users/nylaworker/cs257assignments-NylaWorker/board.txt");
        bo.printBoard(bo);
      }
